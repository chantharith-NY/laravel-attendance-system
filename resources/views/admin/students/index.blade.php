                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex flex-wrap gap-2">
                                                <a href="{{ route('admin.students.show', $student) }}" class="px-3 py-1 bg-blue-500 text-white rounded text-xs hover:bg-blue-600">View</a>
                                                <a href="{{ route('admin.students.edit', $student) }}" class="px-3 py-1 bg-indigo-500 text-white rounded text-xs hover:bg-indigo-600">Edit</a>
